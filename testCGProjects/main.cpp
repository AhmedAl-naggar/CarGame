...
void fristDesign(){
        ...
        //Road Backgound
        glColor3f(0.000, 0.392, 0.000);// This Color Of Background of road 
        glBegin(GL_POLYGON);
        glVertex2f(0,2);
        glVertex2f(100,55);
        ...
        glColor3f(00, 0, 0); //this Color of Road when player befor start or loses in game
        glBegin(GL_TRIANGLES);
        ...
        glEnd();
        //Road Midle
        glColor3f(1, 1, 1);// this color of midle line in 
        glBegin(GL_TRIANGLES);
        glVertex2f(32-2+21,55);//the direction of line
        glVertex2f(50+2,50-50);//the width of right
        glVertex2f(50-2,50-50);// the width of left
        glEnd();

         //Road Sky
		//the Color Of Sky Contian two color 
        glColor3f(0.000, 0.749, 1.000);// Frist Color  
        glBegin(GL_POLYGON);
        glVertex2f(100,100);
        glVertex2f(0,100);
        glColor3f(0.686, 0.933, 0.933);// Second Color 
        glVertex2f(0,55);
        glVertex2f(100,55);
        glEnd();
      ...
      glColor3f(0.133, 0.545, 0.133);
        ...
        //Menu Place Holder
        glColor3f(0.098, 0.098, 0.439);// the color of background of menu color : blue
        glBegin(GL_POLYGON);
        ...
        glColor3f(00, 0, 0.000);// The Color Of Border In Menu Color :black
        glBegin(GL_POLYGON);
        glVertex2f(32-4,50+5+10);
        glVertex2f(32+46,50+5+10);
		...
		// This is Postion Of Background Blue 
        glBegin(GL_POLYGON);
        ...
        if(gv==1){
            glColor3f(1.000, 0.000, 0.000);// The Color :Red , Of Font Word "GAME OVER" 
            renderBitmapString(35,60+10,(void *)font1,"GAME OVER");
            glColor3f(1.000, 0.000, 0.000);
            char buffer2 [50]; // The Size Of Score
            sprintf (buffer2, "Your Score is : %d", score);// Print The Score 
        ...
        renderBitmapString(30-5,50-43,(void *)font3,"Group 1");
...
int main(int argc, char *argv[])
{
	...
	glutCreateWindow("Group #1 Car Game");
